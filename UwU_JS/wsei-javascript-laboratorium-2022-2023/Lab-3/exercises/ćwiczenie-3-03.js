...
function makeTransaction(transaction){
    if(!sourceAccount in transaction)  throw new Error('Impossible to complete the transaction. Absent property sourceAccount in transaction!');
    if(!amount in transaction)  throw new Error('Impossible to complete the transaction. Absent property amount in transaction!');
    if(!targetAccount in transaction)  throw new Error('Impossible to complete the transaction. Absent property targetAccount in transaction!');
